...
const HackerRoom = (props) => {
  ...
  const firstScreenTxt = useTexture("textures/desk/firstscreen.png");
  const secondScreenTxt = useTexture("textures/desk/secondscreen.png");
  const thirdScreenTxt = useTexture("textures/desk/thirdscreen.png");
  const topScreenTxt = useTexture("textures/desk/topscreen.png");
  return (
    <group {...props} dispose={null}>
      ...
      >
        <meshMatcapMaterial map={secondScreenTxt} />
      </mesh>
      ...
      >
        <meshMatcapMaterial map={topScreenTxt} />
      </mesh>
      <mesh
        castShadow
        receiveShadow
      ...
      <mesh
        ...
        scale={[1.822, 1.36, 0.851]}
      >
        <meshMatcapMaterial map={firstScreenTxt} />
      </mesh>
      <mesh
        castShadow
        receiveShadow
        ...
        scale={[1.822, 1.36, 0.851]}
      >
        <meshMatcapMaterial map={thirdScreenTxt} />
      </mesh>
      <mesh
        castShadow
        receiveShadow
